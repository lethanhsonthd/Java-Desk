...
public class DeleteMobileServlet extends HttpServlet {
    ...
    private final String SEARCH_PAGE = "searchMobile.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean res = dao.deleteMobile(pk);
            if (!res) {
                urlRewriting = "errPageDeletePage.html";
            }
        } catch (SQLException ex) {
            Logger.getLogger(DeleteMobileServlet.class.getName()).log(Level.SEVERE, null, ex);
